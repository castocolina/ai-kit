...
save_statusline_config(path, seg_changes, layout, worktree, status_line) -> bool  # E5c: persists wizard edits (atomic + doctor-revert); not used in E5b
